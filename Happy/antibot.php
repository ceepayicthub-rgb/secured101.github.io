<?php
    ...
    $botList = fopen("../Export/key/kill.txt", "r");
    $settings = parse_ini_file("../Exec.ini");
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="./script/reset.php?page=anti">Reset Logs <i class="fad fa-trash-alt"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./script/logout.php">Logout <i class="fad fa-sign-out"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div>
                                <span>
                                    <?php
                                        ...
                                        $botFile = fopen("../Export/key/kill.txt", "r");
                                    
                                        if (trim(fgets(fopen("../Export/key/kill.txt", "r"))) == "") {
